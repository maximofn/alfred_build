...
rm fedora/alfred-1.3-3.fc36.x86_64.rpm
docker build -f docker/Dockerfile.fedora_build -t maximofn/fedora36_build:0.0.1 ../
docker run -it --rm -v ./fedora/:/mnt maximofn/fedora36_build:0.0.1 cp /root/rpmbuild/RPMS/x86_64/alfred-1.3-3.fc36.x86_64.rpm /mnt
